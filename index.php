...
<div class="modal fade center" id="modalNewEvent" tabindex="-1" role="dialog" aria-labelledby="modalNewEventLabel"
     aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-10">
						<form role="form" enctype="multipart/form-data" id="NewEventFormSubmit" action="newEvent.php"
						      method="post">
